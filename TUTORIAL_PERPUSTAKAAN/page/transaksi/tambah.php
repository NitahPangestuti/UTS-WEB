                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="tgl_pinjam" id="tgl" value="
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="tgl_kembali" id="tgl" value="
                                            <?php echo $kembali;?>" readonly  />
                                            
                                        </div>

                                            <input type="submit" name="simpan" value="Simpan" style="margin-top: 8px"
    ...
    while ($data = $sql->fetch_assoc()) {
        ...
        if ($sisa == 0) {
           ?>
            ...
            $sql1 = $koneksi->query("update tb_buku set jumlah_buku=(jumlah_buku-1) where id='$id' ");
